...
module.exports = {
  ...
  async execute(interaction, data) {
    ...
    if (voiceConnection == null) {
      return reply(interaction, { type: 4, content: `I'm not connected to any channel. Please connect to a voice channel and use **/join** to invite me.`, flags: 1 << 6 });
    }
